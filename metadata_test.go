...
func testRegExpMetadata(regexp string, test func(*metadata)) {
	source := strings.NewReader(regexp)
	meta, _ := ComputeRegExpMetadata(source)
	test(meta)
}

func TestFirstPos(t *testing.T) {
	testRegExpMetadata(`(<a,>+<b,>)*.<a,>.<b,>.<b,>`, func(meta *metadata) {
...
func TestMulticharFollow(t *testing.T) {
	testRegExpMetadata(`<abc,xy>+<bca,zz>`, func(meta *metadata) {
